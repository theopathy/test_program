...
class Search_Box(Frame):
    def __init__(self, master, button_text="Search", button_ipadx=16, button_background="#009688", button_foreground="white", button_font=None, opacity=0.8, placeholder=None, placeholder_font=None, placeholder_color="grey", entry_highlightthickness=1, entry_width=30, entry_font=None, command=None, ID=None,drawButton = True):
...
class Primary_Panel(Metro_Panel):
    def __init__(self, master, title, width=None,height=None):
        Metro_Panel.__init__(self, master, title, "#2780e3", "#2780e3", width,height)
